...
def getCardFileName():
    ...
    print("CardFileName is: " + CardFileName)
    print("CardFileNamePopulated = " + str(CardFileNamePopulated))
                ...
                while comport['buffer']:
                    ...
                    if HaveCard==0:
                        if CurrentCommand == CARD_READ and "05" in ReadInput:
                            ...
                            comport['ser'].write(output)
                            ReadInput=""
##                            if not CardFileNamePopulated:
##                                (CardFileName, CardFileNamePopulated) = getCardFileName()
##                                if CardFileName:
##                                    (CardBytes, HaveCard) =  ReadCardFile(CardFileName)
##                                else:
##                                    CardFileName = "default.hex"
##                                    print("CardFileName is blank. Using default.hex")
